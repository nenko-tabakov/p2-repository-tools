...
public class RuleProcessor {
    ...
    public RuleProcessor(String outputFormat, String filter) {
    ...
    public String getOutput(Map<String, String> properties) {
    ...
    private String replaceValue(String format, String key, String value) {
